...
/*   Updated: 2020/05/10 15:04:26 by wquinoa          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	t_lstadd(void *newc, void **content, int len)
{
	t_list	*tmp, *new;
	t_list	*res;
...
int		main(int argc, char **argv)
{
	...
	if (argc >= 4)
		if (strcmp(argv[1], "add") == 0)
			t_lstadd((void *)argv[2], (void **)&argv[3], argc);
}